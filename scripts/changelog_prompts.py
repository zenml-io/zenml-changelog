...
def build_release_notes_body_prompt(
    ...
    return (
        ...
        "- Write exactly ONE bullet per PR. Never split a single PR across multiple bullets, and never "
        "restate the same change as both a framing sentence and a bullet.\n"
